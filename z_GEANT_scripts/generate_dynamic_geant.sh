#!/bin/bash
#SBATCH -J dyn_geant_h6_learned_failure
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH --gres=gpu:1
...
#SBATCH --mem=32G
#SBATCH -t 08:00:00
#SBATCH -o logs/dyn_geant_h6_learned_failure_%j.out
#SBATCH -e logs/dyn_geant_h6_learned_failure_%j.err
...
TOPOLOGY_JSON="topologies/geant/t1.json"
PAIRS_PKL="pairs/geant/t1.pkl"
TRAFFIC_DIR="traffic_matrices/geant"
GENERATOR="generate_dynamic_failures.py"

OUT_DIR="dynamic_geant_h6_realistic_learned_failure"
TM_SERIES="$OUT_DIR/geant_tm_series.pkl"
...
echo "Combining GEANT traffic matrices into one time-series file..."
...
out_path = out_dir / "geant_tm_series.pkl"
...
echo "Generating dynamic GEANT h6 dataset with learned-failure labels..."
...
echo "Quick audit of generated GEANT samples..."
...
print()
print("PASS: GEANT dataset format is clean.")
