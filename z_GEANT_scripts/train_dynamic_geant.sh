...
#SBATCH --mem=32G
#SBATCH -t 24:00:00
#SBATCH -o logs/grate_geant_modes_%j.out
#SBATCH -e logs/grate_geant_modes_%j.err
...
TOPO="dynamic_geant"
DATASET="dynamic_geant_h6_realistic_learned_failure"
EXP_NAME="h6_geant_grate_topology_modes_K5_lambda0p5_beta0p1_rau1_lr1e4_epochs5_split700_850_1000"
